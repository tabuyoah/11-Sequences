...
def run_test_count_items_bigger_than():
    ...
    # Test 9:
    sequence = [45, 84, 32, 70, -10, 40, -8, -88, 9]
    threshold = 0
    expected = 6
    actual = count_items_bigger_than(sequence, threshold)
    print()
    ...
    # Test 10:
    sequence = [450, 804, 32, 70, -10, 40, 11, 12, 21, 421]
    threshold = 100
    expected = 3
    actual = count_items_bigger_than(sequence, threshold)
    print()
...
def run_test_count_positive_sines():
    ...
    # Test 11:
    expected = 2
    actual = count_positive_sines([3, 6, 9])
    print()
    print('Test 4 expected:', expected)
    print('       actual:  ', actual)
...
def run_test_sum_first_n():
    ...
    # Test 8:
    expected = 428
    actual = sum_first_n([428, -102, 3450, 55], 1)
    print()
    print('Test 8 expected:', expected)
    print('       actual:  ', actual)
    ...
    # Test 9:
    expected = 25
    actual = sum_first_n([4, -1, 5, 5, 4, 8, 9, 3], 6)
    print()
    print('Test 9 expected:', expected)
    print('       actual:  ', actual)

...
def run_test_count_negatives():
    ...
    # Test 6:
    expected = 3
    actual = count_negatives([-2, 2, -2, -10])
    print()
    ...
    # Test 6:
    expected = 1
    actual = count_negatives((8, 13, 7, -5, -1, -9, 1))
    print()
...
def run_test_count_short_ones():
    ...
    # Test 8:
    expected = 2
    seq = [[3, 4, 1], [222, 123, 44, 1], [1], [1, 1, 1], [1, 1, 1], [0,4], [1, 1, 1]]
    actual = count_short_ones(seq)
    print()
    ...
    # Test 9:
    expected = 3
    seq = ['The', 'quick', 'brown', 'fox', 'a', 'b', 'c', 'woof']
    actual = count_short_ones(seq)
    print()
